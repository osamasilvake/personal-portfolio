...
export default function photoPage({ params: { feedId } }: MyId) {
	const photo: Photo = photos.find((p) => p.id === feedId)!;

	return (
		<section className="py-6">
			<div>
				<div>
					<Link href="/feeds" className="font-semibold italic text-sky-600 underline px-10">
						Back to photos
					</Link>
				</div>
